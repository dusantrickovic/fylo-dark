...
function Header() {
    return (
        <header className="grid bg-maincol p-6 grid-flow-col grid-cols-2">
            <div className="font-sm relative flex-grow">
            ...
            <ul className="flex text-gray-300 text-sm w-72 justify-center flex-shrink justify-self-end">
                <li className="mr-10 pt-5 cursor-pointer hover:text-white transition delay-100">Features</li>
                <li className="mr-10 pt-5 cursor-pointer hover:text-white transition delay-100">Teams</li>
                <li className="mr-10 pt-5 cursor-pointer hover:text-white transition delay-100">Sign in</li>
            </ul>
        </header>
    )
}
